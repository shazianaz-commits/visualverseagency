...
const portfolioItems = [
  ...
  { title: "Hezbollah - Documentary Research Project", category: "AI Documentaries", type: "Research Folder", url: "https://drive.google.com/drive/folders/1ckKuANbx8oh1cfHyH32vxrr4jpTayqkc", image: "assets/logo.jpeg", desc: "Documentary research folder with project materials hosted on Google Drive." },
...
const socialLinks = [
  ["YouTube", "Channel", "https://www.youtube.com/@visual_verse_agency"],
  ["Instagram", "Reels and posts", "https://www.instagram.com/visual_verse_agency/"],
  ["Threads", "Social profile", "https://www.threads.com/@visual_verse_agency"],
  ["Facebook", "Agency profile", "https://www.facebook.com/profile.php?id=61590101997513"],
  ["X", "Updates", "https://x.com/Visual_Verse"],
  ["LinkedIn", "Professional profile", "https://www.linkedin.com/in/shazia-naz-25a519411/"],
  ["Bluesky", "Social profile", "https://bsky.app/profile/visualverseagency.bsky.social"],
  ["Pinterest", "Visual boards", "https://pin.it/47fnpD5mU"],
  ["TikTok", "Short-form content", "https://www.tiktok.com/@visual_verse_agency?lang=en"],
  ["Fiverr Pro", "Freelance services", "https://pro.fiverr.com/sellers/visualverse_0/edit"],
  ["Upwork", "Freelance profile", "https://upwork.com/freelancers/~0177a3cb88ee5b25d9"],
];
...
function renderIntroPreviewWall() {
  const introItems = previewableItems
    .filter((item) => item.image)
    .filter((item) => ["Logo Design", "Thumbnails", "AI Shorts", "Educational Content", "Video Editing", "UGC Ads"].includes(item.category))
    .slice(0, 10);

  document.querySelector("#introPreviewWall").innerHTML = introItems
    .map((item, index) => `
      <span class="intro-preview-tile" style="--delay: ${index * 0.08}s">
